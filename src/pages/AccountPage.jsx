        ...
        <div className="flex gap-2 mt-8 mb-8 min-h-[100vh] text-[16px]">
            ...
            <div className="w-[30%]">
                ...
                <ul className="uppercase font-[500]">
                    <li
                        className={`${activeSection === "gioi_thieu" && 'bg-main-color text-white'} px-3 py-3 mb-1 cursor-pointer hover:bg-main-color hover:text-white transition duration-300 ease-in-out`}
                        onClick={() => handleCLickNav("gioi_thieu")}
                    >giới thiệu
                    </li>

                    <li
                        className={`${activeSection === "gio_hang" && 'bg-main-color text-white'} px-3 py-3 mb-1 cursor-pointer hover:bg-main-color hover:text-white transition duration-300 ease-in-out`}
                    ...
                    <li
                        className={`${activeSection === "don_hang" && 'bg-main-color text-white'} px-3 py-3 mb-1 cursor-pointer hover:bg-main-color hover:text-white transition duration-300 ease-in-out`}
                        onClick={() => handleCLickNav("don_hang")}
                    >
                        đơn hàng
                    </li>
                    <li
                        className={`${activeSection === "dia_chi" && 'bg-main-color text-white'} px-3 py-3 mb-1 cursor-pointer hover:bg-main-color hover:text-white transition duration-300 ease-in-out`}
                    ...
                    <li
                        className={`${activeSection === "tai_khoan" && 'bg-main-color text-white'} px-3 py-3 mb-1 cursor-pointer hover:bg-main-color hover:text-white transition duration-300 ease-in-out`}
