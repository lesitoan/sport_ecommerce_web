        ...
        <>
            <tr className={`${showDetal && 'bg-gray-300'} border-b-2 border-gray-200 hover:bg-gray-300 transition-all`}>
                ...
                <td className="pr-3 py-4">
                    {orderStatus === 'pending' && <span className="text-yellow-600 font-[500]">Chờ xử lý</span>}
                    {orderStatus === 'confirmed' && <span className="text-orange-600 font-[500]">Đã xác nhận</span>}
                    {orderStatus === 'inTransit' && <span className="text-blue-600 font-[500]">Đang vận chuyển</span>}
                    {orderStatus === 'completed' && <span className="text-green-600 font-[500]">Thành công</span>}
                    {orderStatus === 'error' && <span className="text-red-600 font-[500]">Thất bại</span>}
                </td>
                <td className="pr-3 py-4">
