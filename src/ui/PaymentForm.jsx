        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex flex-wrap justify-between">
                ...
                <div className="md:col-span-5 w-[100%]">
                    <input
                        ...
                        type="text"
                        name="address"
                        {...register("address", { required: "địa chỉ này không được để trống*", maxLength: { value: 100, message: "Vượt quá 100 kí tự" } })}
                    />
                ...
                <div className="md:col-span-5 w-[100%]">
                    ...
                    />
                    {errors?.description && <span className='text-red-700 italic text-[14px] py-10'>{errors.description?.message}</span>}
                </div>
            </div>
            ...
            <div className="flex flex-wrap justify-between">
                <div className="flex justify-between items-center border-solid border-2 border-main-color p-2 gap-3 md:col-span-5 w-[49%] cursor-pointer hover:bg-main-color hover:text-white">
                    ...
                    <p>
                        <input type="text" name='paymentMethod' className='hidden' defaultValue="thanh_toan_khi_nhan_hang"
